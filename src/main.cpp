...
unsigned int nStakeMinAge = 8 * 60 * 60; // 24 hours
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Inscriptions on bones is coming.";
        CTransaction txNew;
        txNew.nTime = 1398745646;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1398745646;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 245078 : 216178;

        //// debug print

	assert(block.hashMerkleRoot == uint256("0x1ff71bdfce215f33df9f93179e94e22bb11a853defc640befa92b386562eb298"));
        block.print();
 ...
 /*     printf("block.nTime = %u \n", block.nTime);
        ...
        if (block.hashMerkleRoot != uint256("0xbd7a1d4bb4906e28c078fe797f171a332231bc533ddf354f73cf58e8fb0ddbde"))
        {
...
printf("block.nTime = %u \n", block.nTime);
        ...
        printf("%s\n", block.hashMerkleRoot.ToString().c_str());
        block.print();
        assert(block.hashMerkleRoot == uint256("0xbd7a1d4bb4906e28c078fe797f171a332231bc533ddf354f73cf58e8fb0ddbde"));
