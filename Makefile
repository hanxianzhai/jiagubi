#############################################################################
# Makefile for building: bonescoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? 4? 29 09:50:47 2014
# Project:  bonescoin-qt.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -o Makefile bonescoin-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DLINUX -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_CORE_LIB -DQT_SHARED
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /home/xxx/git/fujian/blackcoin/src/leveldb/libleveldb.a /home/xxx/git/fujian/blackcoin/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = src/txdb-leveldb.cpp \
		...
		src/zerocoin/ZeroTest.cpp build/moc_bitcoingui.cpp \
...
Makefile: bonescoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o Makefile bonescoin-qt.pro
...
/home/xxx/git/fujian/blackcoin/src/leveldb/libleveldb.a: FORCE
	cd /home/xxx/git/fujian/blackcoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/xxx/git/fujian/blackcoin/build/build.h: FORCE
	cd /home/xxx/git/fujian/blackcoin; /bin/sh share/genbuild.sh /home/xxx/git/fujian/blackcoin/build/build.h
...
src/qt/locale/bitcoin_ca@valencia.qm: src/qt/locale/bitcoin_ca@valencia.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/bitcoin_ca@valencia.ts -qm src/qt/locale/bitcoin_ca@valencia.qm
